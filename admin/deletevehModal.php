...
<div class="modal fade" id="signupModal" tabindex="-1" aria-labelledby="signupModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <p>Buy deleting this item, you can't restore it later !</p>
            </div>
        ...
        <button type="button" class="btn btn-danger mt-4" style="width: 170px; margin-left:20px; margin-bottom :20px;">Yes,Delete</button> </a>
