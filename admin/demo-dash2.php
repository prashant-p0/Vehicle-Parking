				...
				<div class="row mx-auto">
					<div class="col-xs-2 col-md-3 col-lg-3 no-padding">
						...
						<div class="row no-padding">
							<img class="round ms-5" src="map.png" style="width: 150px; height:80px " alt="Icon">
							<div class="large fs-4 text-center "><?php include 'counters/parking-count.php' ?></div>
							<div class="text-muted text-center fs-5">Total Vehicles Parked</div>
						</div>
						<!-- </div> -->
					</div>
					<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
						<div class="panel panel-blue panel-widget border-right">
							<div class="row no-padding"><em class="fa fa-xl fa-toggle-on color-orange"></em>
								<img class="round" src="perspective3.png" style="width: 270px; "  alt="Icon">

								<div class="large fs-4 text-center"><?php include 'counters/invehicles-count.php' ?></div>
								<div class="text-muted text-center fs-5">Vehicles IN</div>
							</div>
						</div>
					</div>
					<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
						<div class="panel panel-orange panel-widget border-right">
							<div class="row no-padding"><em class="fa fa-xl fa-toggle-off color-teal"></em>
								<img class="round ms-4" src="perspective_matte.png" style="width: 270px; "  alt="Icon">
								<div class="large fs-4 text-center me-5"><?php include 'counters/outvehicles-count.php' ?></div>
								<div class="text-muted text-center fs-5">Vehicles OUT</div>
							</div>
						</div>
					</div>
					<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
						<div class="panel panel-red panel-widget ">
							<div class="row no-padding"><em class="fa fa-xl fa-clock-o color-red"></em>
								<img class="round ms-2" src="perspective.png" style="width: 270px; "  alt="Icon">

								<div class="large fs-4 me-5 text-center"><?php include 'counters/current-parkingCount.php' ?></div>
								<div class="text-muted text-center fs-5">Parking Done within 24 hrs</div>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row">
                    ...
                    .container .card:hover .content{
						...
						<div class="col-md-4" style="margin-top: 40px;">
							<div class="text-white card bg-success bg-gradient " style="border-radius:30px;">
                            <div class="content">
								...
								<ul style="list-style: none;">
									<li class="me-3 ms-1" style="font-size: 20px;">1 '.$desc.' : FOR ' .$amount.'.00 INR</li>
								</ul>

								<ul style="list-style: none;">
									<li>
										<h4 style="font-weight: bolder">Starting '. date("d-M-Y") .' </h4>
									</li>
								</ul>
								<ul class="ps-5 mb-3">
									...
									<li class="pb-1">Cancel anytime. <button class="btn btn-success " data-bs-toggle="modal" data-bs-target="#loginModal"> offer terms</button> apply.</li>
