...
if (isset($_POST['userresetpw'])) {
	...
	$eng_no = $_SESSION['eng_no'];
	$password = md5($_POST['newpassword']);

	$query = mysqli_query($con, "UPDATE user set password='$password'  where  username='$username'");
...
<body>
	...
	<div class="jumbotron">
		<form method="post">
			...
			<button type="submit" name="userresetpw" class="btn btn-success button">Proceed</button>
		</form>
