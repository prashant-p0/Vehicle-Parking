...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="jumbotron col-md-12 shadow-lg">
                ...
                <h4 class="pt-4 px-3">Transcaction done Successfully.</h4>
                <!-- <h4 class=" pt-2 text-center">Thanks For Buying Subscription! </h4> -->
    ...
    <li class="box-row d-flex flex-item-center" >
                ...
                <div class="d-grid gap-2 col-2 mx-auto">
                    <a href="out-vehicles.php"><button type="submit" name="login"
