...
?>
  ...
  <body class="c1">
    ...
    ?>
    <div class="container">
      <h1 class="panel-heading text-center">Update Vehicle</h1>
          ...
          <div class="col-sm-4">
            <div class="ca card rounded mb-3 shadow-lg">
              <div class="card-body">
                ...
                <p class="card-text"><b>validity: </b>'.$validity.'</p>
                <a href="upgrade-sub-veh.php?subid='.$id.'"  name="entry-vehicle" class="btn btn-success float-end">Update vehicle</a>
              </div>
            </div>
          </div>
        </form>
