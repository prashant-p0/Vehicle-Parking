...
?>
  ...
  <body class="c1">
    ...
    ?>
    <div class="container">
      <h1 class="panel-heading text-center">Daily User History</h1>
      ...
      <form method="POST">
        <div class=" my-4">
                ...
                $ret = mysqli_query($con, "SELECT * from  vehicle_info_log;");
                $cnt = 1;
                ...
                while ($row = mysqli_fetch_array($ret)) {
                  ...
                  $d = $row['req_date'];
                  $date = date_create($d);
                  $req_date = date_format($date, "d-M-y");
    ...
    <?php $cnt = $cnt + 1;
                ...
                <b>Daily User-History Not Found..</b>
              </div>
              <img src="includes/img/history1.png" style="height:380px; width:350px;margin-left:470px">';
              }?>
