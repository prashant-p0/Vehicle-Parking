...
if (strlen($_SESSION['user'] == 0)) {
    ...
    if (isset($_POST['submit-detail'])) {
        ...
        if ($num > 0) {
            ...
            $update = mysqli_query($con, "UPDATE subscripted_user set ownername='$name', mail='$mail', plan='$plan', amount='$amount1', validity= '$validity', edate='$date5', status = '$st' where vehicle_no='$vehreno'");
        } else {
            $sdate = date("Y-m-d");
            $date = date_create($sdate);
            date_modify($date, "+ $validity");
            ...
            $query = mysqli_query($con, "INSERT INTO `subscripted_user` (`sid`, `vehicle_no`, `vehiclename`, `vehicle_cat`, `ownername`,`mail`, `phone`, `plan`, `amount`, `validity`, `uid`, `sdate`, `edate`) VALUES (NULL, '$vehreno', '$company', '$catename', '$name','$mail', '$user_phone', '$plan', '$amount1', '$validity', '$user', current_timestamp(), '$date1');");
            ...
            if ($query) {
                ...
                $_SESSION['buy'] = "Subscription Done successfully , please check your email id..";
            ...
            <div class="container">
                ...
                <form method="POST" class="row g-4 needs-validation" novalidate>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="email" class="form-control" id="mail" name="mail" placeholder="Enter here.." required>
                        <div class="invalid-feedback">
                        ...
                        <label for="validationCustom03" class="form-label">Amount
                            ...
                            <div class="amount-ref">
                                ...
                                ?>
                                    ...
                                    <div data-label="<?php echo $row['category']; ?>" data-value="<?php echo $row['amount']; ?>">
        ...
        <script>
          ...
          <script>
            function pay_now() {
                ...
                if (name==null || name=="",company==null || company=="",mail==null || mail=="") {
