...
$con=mysqli_connect('localhost','root','','vehicle-parking-db');
        // $cid=$_GET['viewid'];
        $user = $_SESSION['user'];
        $ret = mysqli_query($con, "SELECT * from  vehicle_info WHERE uid= '$user' order by `ID` desc limit 1 ");
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="jumbotron col-md-12 shadow-lg">
                ...
                <h4 class="pt-3 px-3">Transcaction done Successfully.</h4>
                <h6 class=" pt-2 text-center">Your Payment ID is: <b><?php echo $row['payment_id'] ?></b></h6>
    ...
    <li class="box-row d-flex flex-item-center" >
                ...
                <div class="d-grid gap-2 col-2 mx-auto">
                    <a href="dashboard1.php"><button type="submit" name="login"
