...
if (strlen($_SESSION['user'] == 0)) {
    ...
    if (isset($_POST['delete'])) {
        $sid = $_GET['sid'];
        $query = mysqli_query($con, "update subscripted_user set status='deleted' where sid='$sid'");
        if ($query) {
            $_SESSION['delete'] = "Subscription Deleted successfully";
    ...
    <body>
        ...
        <div class="container" style="margin-top:10px">
            ...
            <div class="jumbotron">
                ...
                <h1 class="panel-heading text-center " style="color:red">Cancel Subscription</h1>
						...
						<em class='fa fa-lg fa-close'>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <form method="POST">
                                            ...
                                            <?php
                                            $sid = $_GET['sid'];
                                            $ret = mysqli_query($con, "SELECT * from subscripted_user where sid='$sid'");
                                            $cnt = 1;
                                            ...
                                            ?>
                                                ...
                                                <ul>
                                                    <li>
                                                        <div class="alert alert-warning d-flex align-items-center" style="width:520px;margin-top:20px;margin-bottom:none" role="alert">
                                                            <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="Info:">
                                                                <use xlink:href="#info-fill" />
                                                            </svg>
                                                            <div>
                                                ...
                                                <li class="box-row d-flex flex-item-center" >
                                                    ...
                                                    <div class="p-2 ">
                                                        <input type="text" style="width:200px;background:black;color:red;border:none;font-size:22px" class="form-control" value="<?php echo $row['vehicle_no']; ?>" id="sdesc" name="firstname" readonly>
                                                    </div>
                                                </li>
                                                <li class="box-row d-flex flex-item-center" >
                                                    <div class="form-group p-3 fs-5 " style=" margin-left:100px">
                                                    ...
                                                    <div class="p-2 ">
                                                        <input type="text" style="width:200px;background:black;color:red;border:none;font-size:22px" class="form-control" value="<?php echo $row['vehiclename']; ?>" id="sdesc" name="firstname" readonly>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="box-row d-flex flex-item-center ">
                                                    ...
                                                    <div class="p-2 ">
                                                        <input type="text" style="width:200px;background:black;color:red;border:none;font-size:22px" class="form-control" value="<?php echo $row['phone']; ?>" id="sdesc" name="firstname" readonly>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="box-row d-flex flex-item-center ">
                                                    ...
                                                    <div class="p-2 ">
                                                        <input type="text" style="width:200px;background:black;color:red;border:none;font-size:22px" class="form-control" value="<?php echo $row['amount']; ?>" id="sdesc" name="firstname" readonly>
                                                    </div>
                                                </li>
                                        ...
                                        <a href="module.php"><button type="submit" class="btn btn-outline-info" style="margin-left: 470px;">Back</button></a>
