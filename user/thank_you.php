...
$con=mysqli_connect('localhost','root','','vehicle-parking-db');
        // $cid=$_GET['viewid'];
        $user = $_SESSION['user'];
        $ret = mysqli_query($con, "SELECT * from  subscripted_user WHERE uid= '$user' order by `sid` desc limit 1 ");
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="jumbotron col-md-12 shadow-lg">
                ...
                <h6 class="pt-1 px-3 text-center">Give us feedback here.<a href="feedback.php" class="link-primary">Click Here</a></h6>
    ...
    <li class="box-row d-flex flex-item-center" >
                ...
                <div class="d-grid gap-2 col-2 mx-auto">
                    <a href="module.php"><button type="submit" name="login"
